...
function main(){
    ...
    if( argv.i || argv["include-path"] ){
        options.includePath = ( argv.i || argv["include-path"] ).split( path.delimiter );
    }
...
function getHelp(){
    ...
    var str = [
        ...
        "    -i / --include-path d1"+path.delimiter+"d2  Look for dependencies in these directories.",
...
function getVersion(){
    ...
    var str = [
        ...
        "Copyright (C) 2014,2015 Emilis Dambauskas.",
        "",
